...
public class PurchaseOrderItem {
    ...
    PurchaseOrderItem(
        ...
        apply(product, quantity, unitPrice, taxRate);
    }

    void updateDraft(Product product, long quantity, BigDecimal unitPrice, BigDecimal taxRate) {
        apply(product, quantity, unitPrice, taxRate);
    }

    private void apply(Product product, long quantity, BigDecimal unitPrice, BigDecimal taxRate) {
